...
header("Access-Control-Allow-Methods: POST"); // POST is safer than DELETE for some servers
...
// 4. (Optional) Delete the image file first
$check = $conn->query("SELECT image FROM categories WHERE id = $id");
if ($check->num_rows > 0) {
